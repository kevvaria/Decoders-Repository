...
Restaurant :: Restaurant(){
	...
	name = "";
	distance = distanceTravelled = 0.0;
	head = tail = NULL;
	restaurantCount = menuItemCount = 0;
}

//Constructor
Restaurant :: Restaurant(string rName, double dist){
...
void Restaurant :: RelocateRestaurant(string rName, double dist){
	name = rName;
	distance += dist;
	restaurantCount++;
}
...
void Restaurant :: AddMenuItem(string nameItem, double priceItem){
...
void Restaurant :: RemoveMenuItem(string removeName){
...
//Change Item Price
void Restaurant :: ChangeItemPrice(string changename, double newPrice){
...
double Restaurant :: getRestaurantDistance(){
