...
public:
    ...
    void setupUi(QDialog *Login)
    {
        ...
        Login->resize(207, 171);
        Login->setStyleSheet(QLatin1String("QToolTip\n"
"{\n"
...
""
        ...
        pwEdit->setLayoutDirection(Qt::LeftToRight);
        pwEdit->setEchoMode(QLineEdit::Password);
        pwEdit->setAlignment(Qt::AlignLeading|Qt::AlignLeft|Qt::AlignVCenter);
        splitter->addWidget(pwEdit);
    ...
    void retranslateUi(QDialog *Login)
    {
        ...
        label->setText(QApplication::translate("Login", "<html><head/><body><p><span style=\" font-size:16pt;\">Enter the Password:</span></p></body></html>", 0));
    } // retranslateUi
